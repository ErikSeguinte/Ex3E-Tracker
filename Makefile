#############################################################################
# Makefile for building: Ex3E-Tracker
# Generated by qmake (3.0) (Qt 5.4.2)
# Project:  Ex3E-Tracker.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile Ex3E-Tracker.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Ex3E-Tracker1.0.0
DISTDIR = /home/primefactorx01/c++/Ex3E-Tracker/.tmp/Ex3E-Tracker1.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
$(TARGET): ui_About_gui.h ui_attack_gui.h ui_character_picker_ui.h ui_custom_gambit.h ui_decisive_gui.h ui_join_battle_gui.h ui_main_window.h ui_Modification_Window.h ui_new_character_ui.h ui_other_action_gui.h ui_preferences_window.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Ex3E-Tracker.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Ex3E-Tracker.pro
...
compiler_uic_clean:
	-$(DEL_FILE) ui_About_gui.h ui_attack_gui.h ui_character_picker_ui.h ui_custom_gambit.h ui_decisive_gui.h ui_join_battle_gui.h ui_main_window.h ui_Modification_Window.h ui_new_character_ui.h ui_other_action_gui.h ui_preferences_window.h
ui_About_gui.h: gui/About_gui.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/About_gui.ui -o ui_About_gui.h

ui_attack_gui.h: gui/attack_gui.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/attack_gui.ui -o ui_attack_gui.h

ui_character_picker_ui.h: gui/character_picker_ui.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/character_picker_ui.ui -o ui_character_picker_ui.h

ui_custom_gambit.h: gui/custom_gambit.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/custom_gambit.ui -o ui_custom_gambit.h

ui_decisive_gui.h: gui/decisive_gui.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/decisive_gui.ui -o ui_decisive_gui.h

ui_join_battle_gui.h: gui/join_battle_gui.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/join_battle_gui.ui -o ui_join_battle_gui.h

ui_main_window.h: gui/main_window.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/main_window.ui -o ui_main_window.h

ui_Modification_Window.h: gui/Modification_Window.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/Modification_Window.ui -o ui_Modification_Window.h

ui_new_character_ui.h: gui/new_character_ui.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/new_character_ui.ui -o ui_new_character_ui.h

ui_other_action_gui.h: gui/other_action_gui.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/other_action_gui.ui -o ui_other_action_gui.h

ui_preferences_window.h: gui/preferences_window.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic gui/preferences_window.ui -o ui_preferences_window.h
